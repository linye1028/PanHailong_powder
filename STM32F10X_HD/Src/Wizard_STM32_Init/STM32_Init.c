 ...
 * History:
 *          V1.3.1    change   
 *			        USART1_IRQChannel    -> USART1_IRQn 
       				USART2_IRQChannel    -> USART2_IRQn 
       				USART3_IRQChannel    -> USART3_IRQn 

 *          
 *
 *
 * 			V1.30 error correction for referencing TIM4_CCMR2
 *          V1.29 error correction for accessing NVIC->ISER
...
//         </h>
//         <h> Channel configured as input
//           <o55.12..15> TIM4_CCMR2.IC4F: Input Capture 4 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o55.10..11> TIM4_CCMR2.IC4PSC: Input Capture 4 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
...
#define __TIM3_DIER               0x0001                  // 47
#define __TIM4_PERIOD             0x02710                 // 48
...
#define __USART_USED              0x02                    //  1
#define __USART_DETAILS           0x00                    //  2
#define __USART_INTERRUPTS        0x04                    //  3
...
__inline static void stm32_TimerSetup (void) {
  ...
  if (__TIMER_USED & 0x01) {                                // TIM1 used
    ...
    if (__TIMER_DETAILS & 0x01) {                           // detailed settings used
      ...
      TIM1->BDTR  = __TIM1_BDTR;                            // set break and dead-time register
